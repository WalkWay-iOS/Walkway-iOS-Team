...
extension CourseWalkingInfoCVC {
    ...
    func setLabel() {
        hotPlaceInfoTitleLabel.font = .myBoldSystemFont(ofSize: 15)
        hotPlaceInfoTitleLabel.textColor = .bookmarkDarkBlue
    ...
    func setButton() {
        ...
        landmarkKeywordButton.titleLabel?.font = .myBoldSystemFont(ofSize: 11)
        landmarkKeywordButton.setTitleColor(.white, for: .normal)
        landmarkKeywordButton.backgroundColor = .bookmarkDarkBlue
        landmarkKeywordButton.layer.cornerRadius = 10
        landmarkKeywordButton.contentEdgeInsets = UIEdgeInsets(top: 5, left: 13, bottom: 5, right: 13)
    }
}
