...
class BookmarkCourseTVC: UITableViewCell {
    static let identifier = "BookmarkCourseTVC"
...
extension BookmarkCourseTVC {
    ...
    private func setLabel() {
        ...
        bookmarkLabel.font = .myRegularSystemFont(ofSize: 11)
    }
...
extension BookmarkCourseTVC {
    ...
    private func setHashtagButtons(buttons: [Hashtag]) {
        let colors: [UIColor] = [.popularGreen, .popularBrown, .popularLightBrown, .bookmarkDarkBlue, .bookmarkLightBlue]
        var index = 0
